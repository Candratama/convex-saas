...
function Index() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col bg-card">
      ...
      <div
        className={cn(
          "sticky top-4 z-50 mx-auto flex w-full max-w-screen-lg items-center justify-between px-6 py-3 transition-all duration-300 rounded-lg",
          isScrolled &&
            "backdrop-blur-xl bg-background/20 border border-border/20 shadow-lg shadow-background/5",
        )}
      >
      ...
      <div className="z-10 mx-auto flex w-full max-w-screen-lg flex-col gap-4 px-6">
        <div className="z-10 flex h-full w-full flex-col items-center justify-center gap-4 p-12 md:p-24">
          ...
          <p className="max-w-screen-md text-center text-lg !leading-normal text-muted-foreground md:text-xl">
            ...
            <br className="hidden lg:inline-block" /> Mayar integration.
        ...
        <div className="flex w-full flex-col items-center justify-center gap-2">
          ...
          <div className="my-8 flex flex-wrap items-center justify-center gap-10 gap-y-8 lg:gap-14">
            ...
            <a
              ...
              rel="noreferrer"
              aria-label="Mayar"
              className="flex items-center text-primary grayscale brightness-0 opacity-80 transition hover:opacity-100 dark:invert"
              href="https://mayar.id"
            >
              <img
                src="/images/mayar-logo.png"
                alt="Mayar"
                className="h-12 w-auto"
              />
            </a>
